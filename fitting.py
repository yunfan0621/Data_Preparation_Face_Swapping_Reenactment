...
# import FLAME models
sys.path.append('./3DMM_models/FLAME_Fitting/')
from renderer import Renderer
import util

sys.path.append('./3DMM_models/FLAME_Fitting/models/')
...
class PhotometricFitting(object):
    ...
    def _setup_renderer(self):
        mesh_file = './3DMM_models/FLAME_Fitting/data/head_template_mesh.obj'
    ...
    def optimize(self, images, landmarks, image_masks, savefolder=None):
        ...
        for k in range(200):
            ...
            if self.config.save_all_output and k % self.config.print_freq == 0:
                ...
                savefolder_iter = os.path.join(savefolder, 'inter_steps')
    ...
    def run(self, imagepath, landmarkpath):
        ...
        image_mask_folder = './3DMM_models/FLAME_Fitting/FFHQ_seg'
...
if __name__ == '__main__':
    ...
    config = {
        # FLAME model path
        'flame_model_path': './3DMM_models/FLAME_Fitting/data/generic_model.pkl',
        'flame_lmk_embedding_path': './3DMM_models/FLAME_Fitting/data/landmark_embedding.npy',
        'tex_space_path': './3DMM_models/FLAME_Fitting/data/FLAME_texture.npz',
        ...
        'e_lr': 0.005,
        'e_wd': 0.0001,
        'savefolder': './sample/fitting_results/',
    ...
    input_folder = '/data/yunfan.liu/Data_Preparation_Face_Swapping_Reenactment/3DMM_models/FLAME_Fitting/FFHQ'
